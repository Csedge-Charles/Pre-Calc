...
var_2 = random.randint(-3, 3)
var_3 = random.randint(-4, 4)
...
my_quadratic = f'x²{var_sign_2}{var_2}{x_me}{var_sign_3}{var_3}'
...
if decider == 1:
    ...
    print()
    polynomial = f'{copy_1}x⁵ {sign_1} {copy_2}x⁴ {sign_2} {copy_3}x³ {sign_3} {copy_4}x² {sign_4} {copy_5}x {sign_5} {copy_6}'
    input(f'{polynomial} / {my_quadratic}: ')
    print()
...
if decider == 2:
    ...
    print('What are the roots of: ')
    print()
    input(f'{copy_1}x⁴ {sign_1} {copy_2}x³ {sign_2} {copy_3}x² {sign_3} {copy_4}x {sign_4} {copy_5} / {my_quadratic}: ')
    print()
...
if decider == 3:
    ...
    print('What are the roots of: ')
    print()
    input(f'{copy_1}x³ {sign_1} {copy_2}x² {sign_2} {copy_3}x {sign_3} {copy_4} / {my_quadratic}: ')
    print()
